...
\end{code}
\noindent
\jamey{I suggest not naming this ``main''; its type will confuse C programmers.}
...
\jamey{I this this expression is too complicated for the constant folder. An
SMT solver could sort it out, of course.}
