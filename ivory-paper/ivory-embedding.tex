...
\trevor{Describe why it's useful to have the Body type, and the ensures,
	requires and body combinators.  Particularly, how they constrain the
	location of ensures and requires, and the way that they constrain
	effects in those combinators}
