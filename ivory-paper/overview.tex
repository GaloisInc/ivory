...
\lee{requires/ensures example}
\lee{small importProc example, maybe with requires/ensures}
\lee{toolchain usage overview}
\lee{Describe briefly that Ivory generates an untyped AST. We assume this in
  later discussions.}
