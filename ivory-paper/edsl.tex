...
\jamey{\url{https://github.com/pfultz2/Cloak/wiki/Is-the-C-preprocessor-Turing-complete\%3F}}).
...
\jamey{I'm supposed to fill in here about (1) Haskell as a macro language and
(2) extracting C computed by Haskell libraries like ad and linear that weren't
